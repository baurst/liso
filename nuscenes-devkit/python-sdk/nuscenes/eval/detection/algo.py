...
def accumulate(gt_boxes: EvalBoxes,
    ...
    # Count the positives.
    npos = len([1 for gt_box in gt_boxes.all if class_mapping.get(gt_box.detection_name, gt_box.detection_name) == class_name])
    if verbose:
    ...
    pred_boxes_list = [box for box in pred_boxes.all if class_mapping.get(box.detection_name, box.detection_name) == class_name]
    ...
    for ind in sortind:
        ...
        for gt_idx, gt_box in enumerate(gt_boxes[pred_box.sample_token]):
            ...
            if class_mapping.get(gt_box.detection_name, gt_box.detection_name) == class_name and not (pred_box.sample_token, gt_idx) in taken:
